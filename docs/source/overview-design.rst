...
- ``bolt.local`` for local computation
...
We aim to replicate a large fraction of the Numpy API, so if there's somewhere we're missing that you'd be interested in having, or something you'd like to contribute, create an issue.
